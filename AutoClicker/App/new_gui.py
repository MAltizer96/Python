...
class gui(ttk.Frame):
    ...
    def initScanWidgets(self):
        ...
        self.moveCheck = IntVar()
        self.moveCheckBox = ttk.Checkbutton(self,text='Move', variable=self.moveCheck, onvalue=1,offvalue=0, command=lambda : self.changeMovement())
        self.moveCheckBox.grid(row=2,column=5)
        self.halfScreenCheck = IntVar()
        self.halfScreenScan = ttk.Checkbutton(self,text="Half Screen", variable=self.halfScreenCheck,onvalue=1,offvalue=0, command=lambda : self.changeScanWidth())
        self.halfScreenScan.grid(row=2,column=6)
